    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        <tr>
            <td align="center" style="padding: 40px 20px; text-align: center;">
                ...
                <p style="font-size: 18px; margin-bottom: 20px;">¡Su registro fue exitoso!</p>
                <p style="font-size: 24px; color: #4ecdc4; font-weight: bold; text-transform: uppercase; letter-spacing: 2px;">¡Bienvenido!</p>
            </td>
        </tr>
    </table>
</body>
